...
<table>
  ...
  <tbody>
    {[
      { name: 'Resource one', link: 'https://example.com/', cost: 'Free', description: 'About this resources' },
      { name: 'Resource two', link: 'https://example.com/', cost: 'Free', description: 'About this resources' }
    ].map(item => (
      <tr key={item.name}>
